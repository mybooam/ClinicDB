...
module Print::ProcedureHelper
  def print_procedure(pdf, visit)
    top_box_stamp(pdf, :visit => visit, :title => Setting.get("procedure_visit_header", "Procedure Note"))
    footer_stamp(pdf, 1)
    ...
    y = page_width_box_text pdf, "HPI", y-0.15.in, 1.in, visit.hpi
    
    y = page_width_box_text pdf, "Procedure Note", y-0.15.in, 1.5.in, visit.procedure_note
    
    y = page_width_box_text pdf, "Assessment/Plan", y-0.15.in, 1.in, visit.assessment_and_plan
